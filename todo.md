...
## Audio Playback Control Issue
- [x] Fix multiple songs playing simultaneously
- [x] Create global audio context to manage playback state
- [x] Ensure only one track plays at a time across all audio players
- [x] Automatically pause other tracks when user plays a new track
- [x] Test audio playback control across album workspace and playlist pages
